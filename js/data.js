...
var RULES = [
  { kw: ['팀장', '상사', '부장', '과장'], topic: '회사',
    melang: ['팀장님이 뭐라고 말하셨길래?', '그 말 듣고 기분이 어땠어? 화났어, 아니면 속상한 쪽이었어?'],
    kochi:  ['지난번에도 같은 얘기였지. 이번이 몇 번째야.', '정확히 뭐라고 했는데? 그대로 말해봐.'] },
  { kw: ['회사', '출근', '야근', '회의', '업무'], topic: '회사',
    melang: ['회사 얘기구나. 천천히 말해줘.', '오늘 제일 힘 빠졌던 순간이 언제였어?'],
    kochi:  ['응. 듣고 있어. 계속해.', '제일 문제였던 건 사람이야, 일이야?'] },
  { kw: ['힘들', '지쳤', '우울', '피곤', '불안'], topic: '마음',
    melang: ['으으, 많이 힘들었구나… 여기 와서 앉아 츄.', '그 마음, 언제부터 그랬는지 기억나?'],
    kochi:  ['힘든 건 사실이야. 부정 안 할게.', '근데 작년 이맘때 너, 이거보다 큰 것도 넘겼어. 기억나?'] },
  { kw: ['좋아', '행복', '신나', '최고', '기뻐'], topic: '좋은 일',
    melang: ['오!! 좋은 일이다!! 츄츄!! 🎉', '그 순간 제일 기억에 남는 장면 하나만 말해줘. 볼주머니에 넣어두고싶어!'],
    kochi:  ['오. 이런 날도 있네.', '뭐가 제일 좋았는지 한 줄로 말해봐. 기록해둘게.'] },
  { kw: ['연애', '남친', '여친', '썸', '남자친구', '여자친구'], topic: '연애',
    melang: ['오! 연애고민이구나! (귀 쫑긋)', '지금 그 관계에서 네가 제일 궁금한 건 뭐야?'],
    kochi:  ['들뜬거보니 제대로 빠졌나보네.', '먼저 연락한 적은 있어? 횟수만 물어보는 거야.'] },
  { kw: ['사주', '운세', '명반', '팔자'], topic: '사주',
    melang: ['네 명반 얘기! 그건 내 전문 분야야 츄.', '요즘 제일 답답한 게 뭔지 말해줘.'],
    kochi:  ['내가 별 보기 전문이긴 하지.', '그래, 뭐가 궁금해서 왔어?'] },
